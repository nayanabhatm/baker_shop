...
class _$CartStateTearOff {
  ...
  _CartState call({required BuiltList<CartItem> cartItems}) {
    return _CartState(
      cartItems: cartItems,
    );
  }
...
/// @nodoc
mixin _$CartState {
  BuiltList<CartItem> get cartItems => throw _privateConstructorUsedError;
...
abstract class $CartStateCopyWith<$Res> {
  ...
  $Res call({BuiltList<CartItem> cartItems});
}
...
class _$_CartState implements _CartState {
  const _$_CartState({required this.cartItems});
...
abstract class _CartState implements CartState {
  const factory _CartState({required BuiltList<CartItem> cartItems}) =
      _$_CartState;
